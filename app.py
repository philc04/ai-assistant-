...
<div class="wrap">
  ...
  <section id="page-settings" class="page">
    ...
    <div class="card" style="margin-top:18px">
      ...
      <div class="small">Atlas v0.6.0 • Your profile, skills, behavior, memory, and corrections live in Atlas's database.</div>
    </div>
  </section>
</div>
...
async function sendMessage(){
  ...
  try{
    ...
    chatStatus.textContent = "Model: " + data.model + (used.length ? " • Skills: " + used.join(", ") : "");
  }catch(e){
    thinking.remove();
